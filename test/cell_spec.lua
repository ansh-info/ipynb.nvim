...
describe("ipynb.cell", function()
  ...
  describe("module", function()
    ...
    it("exposes expected public functions", function()
      ...
      assert.is_function(cell.notebook_undo)
      assert.is_function(cell.notebook_redo)
      assert.is_function(cell.has_notebook_undo)
      assert.is_function(cell.has_notebook_redo)
      assert.is_function(cell.get_undo_base_seq)
    end)
